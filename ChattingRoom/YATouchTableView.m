...
@implementation YATouchTableView
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
    ...
    if ([_touchDelegate conformsToProtocol:@protocol(TouchTableViewDelegate)] &&
        [_touchDelegate respondsToSelector:@selector(tableView: hitTest:withEvent:)])
    {
        [_touchDelegate tableView:self hitTest:point withEvent:event];
    }
    return view;
}
